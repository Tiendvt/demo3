...
import com.example.foodapp.models.LoginDto;
import com.example.foodapp.models.SignUpDto;
import com.example.foodapp.repositories.RoleRepository;
...
public class AuthController {
    ...
    public ResponseEntity<String> authenticateUser(@RequestBody LoginDto loginDto) {
        // Fixed the missing 'new' keyword and the improper variable assignment
